...
class CustomTextFormField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      margin: EdgeInsets.symmetric(vertical: Responsive.height(0.02,context), horizontal: Responsive.width(0.02,context)),
      child: Column(
        ...
        children: [
          if (label != null)
            Padding(
              padding: EdgeInsets.only(bottom: Responsive.height(0.01, context)),
              child: Text(label,
                  style: TextStyle(
                      fontSize: Responsive.width(0.04,context),
